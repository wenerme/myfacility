...
// export by SELECT id, collation_name FROM information_schema.collations ORDER BY id;
var _CharacterSet_string_map map[CharacterSet]string = map[CharacterSet]string{
	1:   "big5_chinese_ci",
	2:   "latin2_czech_cs",
	3:   "dec8_swedish_ci",
	4:   "cp850_general_ci",
...
func (cs CharacterSet) String() string {
	if str, ok := _CharacterSet_string_map[cs]; ok {
		return str
	}
	return fmt.Sprintf("CharacterSet(%d)", cs)
}
